...
Men have more access to careers that don’t require a college degree, like construction work. There are still high paying jobs available to men without college credentials, while there are relatively few compared to women. Over the years more women have participated in the labor force, and there has been a shift in gender roles, with women no longer expected to marry at a younger age [@st-louis]. 
